...
def main():
    ...
    # # Distance test
    # experiment(0.6, 0, 0, 0, 100, 3, "distance_modified_data")

    # # Bandwidth test
    # experiment(0, 0.90, 0, 0, 100, 3, "bandwidth_modified_data")

    # # Overload test
    # experiment(0, 0, 0.5, 0, 100, 3, "overload_modified_data")

    # # Optimal values
    # experiment(0.6, 0.95, 0.5, 1, 100000, 3, "anon_60-95_modified_data")
    
    # experiment(0, 0, 0, 0, 100000, 3, "anon_60-95_vanilla_data")


    
    experiment(0, 0, 0, 0, 50, 3, "anon_0-0_vanilla_data")

    # experiment(0.4, 0.4, 0.5, 1, 100, 3, "combined_40-40_modified_data")
    # experiment(0.8, 0.4, 0.5, 1, 100, 3, "combined_80-40_modified_data")

    # experiment(0.3, 0.95, 0.5, 1, 100, 3, "combined_30-95_modified_data")
    # experiment(0.8, 0.8, 0.5, 1, 100, 3, "combined_80-80_modified_data")
...
def measure_request(controller):
    """
...
def experiment(distance, bandwidth, overload, flags, NUM_REQUESTS, TIME, filename):
    ...
    tor_process = stem.process.launch_tor_with_config(
        config={
            ...
            #"EntryNodes": f"9BD0EE79BB9878DD6D8D8EA2A288D5E301E5C136,B4E3546B058FEB655A6D8698D97C1459A2DF8E77,8FB6DF980DAABE530944E29247DAE6E85CF3AB8F",
            #"MiddleNodes": f"6D100EE20A83025E4005C655973FF59DF20D9218,C81FBEB6BFA5D17CC5730325C29F98AF00EECD4E,3A63820A01459135D2A66188278199130F6B0015",
            #"ExitNodes": f"01F73DBD9B56C31E3D3AAEB95F8CF1DEB7D9A72F,C7A51E46740C15DEC0535AF5560A1919CE6E5758,E97F58C06E7AA7175F9BE2A3C708325C03FB2FB1",
        },
    ...
    try:
        ...
        with Controller.from_port(port=TOR_CONTROL_PORT) as controller:
            ...
            while i < NUM_REQUESTS:
                ...
                measurement = measure_request(controller)
                if measurement != "error":

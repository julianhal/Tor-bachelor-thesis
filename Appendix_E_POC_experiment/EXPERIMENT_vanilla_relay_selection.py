...
def main():
    ...
    # Distance test
    experiment(0, 0, 0, 0, 100, 3, "distance_vanilla_data")

    # Bandwidth test
    experiment(0, 0, 0, 0, 100, 3, "bandwidth_vanilla_data")

    # Overload test
    experiment(0, 0, 0, 0, 100, 3, "overload_vanilla_data")



    # Optimal values
    experiment(0, 0, 0, 0, 100, 3, "combined_60-95_vanilla_data")

    experiment(0, 0, 0, 0, 100, 3, "combined_40-40_vanilla_data")
    experiment(0, 0, 0, 0, 100, 3, "combined_80-40_vanilla_data")

    experiment(0, 0, 0, 0, 100, 3, "combined_30-95_vanilla_data")
    experiment(0, 0, 0, 0, 100, 3, "combined_80-80_vanilla_data")
